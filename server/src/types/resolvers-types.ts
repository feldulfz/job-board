...
export type ResolversTypes = {
  ApplyForJobInput: ResolverTypeWrapper<Partial<(T)>>;
  Boolean: ResolverTypeWrapper<Partial<(T)>>;
  CancelApplicationInput: ResolverTypeWrapper<Partial<(T)>>;
  Company: ResolverTypeWrapper<Partial<(T)>>;
  CreateJobInput: ResolverTypeWrapper<Partial<(T)>>;
  DateTime: ResolverTypeWrapper<Partial<(T)>>;
  DeleteJobInput: ResolverTypeWrapper<Partial<(T)>>;
  ID: ResolverTypeWrapper<Partial<(T)>>;
  Int: ResolverTypeWrapper<Partial<(T)>>;
  Job: ResolverTypeWrapper<Job>;
  JobType: ResolverTypeWrapper<JobType>;
  LoginInput: ResolverTypeWrapper<Partial<(T)>>;
  Mutation: ResolverTypeWrapper<Record<PropertyKey, never>>;
  Query: ResolverTypeWrapper<Record<PropertyKey, never>>;
  SearchJobsInput: ResolverTypeWrapper<Partial<(T)>>;
  SignupInput: ResolverTypeWrapper<Partial<(T)>>;
  String: ResolverTypeWrapper<Partial<(T)>>;
  User: ResolverTypeWrapper<Partial<(T)>>;
  UserRole: ResolverTypeWrapper<Partial<(T)>>;
};

/** Mapping between all available schema types and the resolvers parents */
export type ResolversParentTypes = {
  ApplyForJobInput: Partial<(T)>;
  Boolean: Partial<(T)>;
  CancelApplicationInput: Partial<(T)>;
  Company: Partial<(T)>;
  CreateJobInput: Partial<(T)>;
  DateTime: Partial<(T)>;
  DeleteJobInput: Partial<(T)>;
  ID: Partial<(T)>;
  Int: Partial<(T)>;
  Job: Job;
  LoginInput: Partial<(T)>;
  Mutation: Record<PropertyKey, never>;
  Query: Record<PropertyKey, never>;
  SearchJobsInput: Partial<(T)>;
  SignupInput: Partial<(T)>;
  String: Partial<(T)>;
  User: Partial<(T)>;
};
